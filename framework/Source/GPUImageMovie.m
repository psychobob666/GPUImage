...
@property(strong, nonatomic)AVURLAsset *inputAsset;
@property(assign, nonatomic)BOOL shouldRead;
- (void)processAsset;
...
- (void)processAsset
{
  ...
  if(!CMTimeRangeEqual(weakSelf.timeRange, kCMTimeRangeInvalid)){
    reader.timeRange=weakSelf.timeRange;
  }
  outputSettings = [NSMutableDictionary dictionary];
  [outputSettings setObject: [NSNumber numberWithInt:kCVPixelFormatType_32BGRA]  forKey: (id)kCVPixelBufferPixelFormatTypeKey];
